...
<!--is ssh actually supported? I don't see any examples, and the sshPublicKey property isn't in any of the scenarios, although it looks like it is referenced in the resource virtualMachine-configuration-settings-linux-ssh.json-->
